...
$(document).ready(function() {
  ...
  $('input#custom-width').on('keydown', function(){
    if(e.keyCode == 13){
      width = $(this).val();
      updateAllSrcAndUrls();
    }
  ...
  $('input#custom-height').on('keydown', function(){
    if(e.keyCode == 13){
      height = $(this).val();
      updateAllSrcAndUrls();
    }
